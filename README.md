...
- Intergrates [Microdata](https://schema.org/docs/gs.html) markup to provide structured data for search engines ([example](https://validator.schema.org/#url=derekenos.com%2Fproject-weather-station))
